...
engine. Mechanics are unchanged from the canvas version, because they were
already locked. What changed is the art, the stack, and the length of the race.
...
race distance, max speed, plus a rocket picker. The picker is there to keep the
